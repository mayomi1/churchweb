        ...
        <div class="col-md-9">
            ...
            if(isset($_GET['id'])){
                ...
                if($row=mysqli_fetch_array($result)){
                     ...
                     $p_vicar= check($row['vicar_adress']);
            $v_image = check($row['vicar_picture']);
            ...
            <div>
                ...
                <h2>Vicar Address</h2>
                <img src="uploaded_image/presvicar/<?php echo $v_image;?>" align="left"  alt="president's picture or vicar" style="margin: 20px 20px 20px 10px;" width="350" height="450">

                    <p style="font-size: large"><?php echo"$p_vicar"?></p>
